...
## 👤 About Me
I am a Detection Engineer and SOC (Security Operations Center) Automation Specialist with extensive experience in threat detection and response. I thrive on leveraging technology to enhance security operations.

## 🌟 Flagship Projects
- **APT Detection Framework**: Developed a comprehensive framework for Advanced Persistent Threat (APT) detection capable of real-time monitoring and alerting.
- **SOC Automation Toolkit**: Created a toolkit that automates routine SOC tasks, reducing response times and enhancing overall operational efficiency.
